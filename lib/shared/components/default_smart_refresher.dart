...
class DefaultSmartRefresher extends StatefulWidget {
  DefaultSmartRefresher({Key? key, required this.child,required this.onRefresh,required this.onLoading}) : super(key: key);
  final Widget child;
  Function onRefresh;
  Function onLoading;
  @override
...
class _DefaultSmartRefresherState extends State<DefaultSmartRefresher> {
  ...
  void _onLoading() async {
    ...
    await PostCubit.get(context).onLoading();
    print('_onLoading');
    ...
    return SmartRefresher(
        ...
        header: WaterDropHeader(
          ...
          children: [
            Icon(Icons.done),
            SizedBox(width: 10,),
            Text('refresh-completed'.tr().toString(),style: Theme.of(context).textTheme.headline2,)
          ],
        ),),
        footer: CustomFooter(
